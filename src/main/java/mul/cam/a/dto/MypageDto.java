...
public class MypageDto implements Serializable {
	...
	public MypageDto(int seq, String id, String nickname, int ref, int step, int depth, String title, String content,
	...
	public String toString() {
		return "MypageDto [seq=" + seq + ", id=" + id + ", nickname=" + nickname + ", ref=" + ref + ", step=" + step
